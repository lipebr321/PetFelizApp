...
namespace APIPetFeliz.DAO.Pets
{
    public class PetsDAO
    {
        ...
        public void CadastrarPet(PetsDTO pet)
        {
            ...
            try
            {
                ...
                int codLog = (int)cmd.ExecuteScalar();*/
                    ...
                    var sqlPet = "insert into Tb_Pet (Nome_Pet, Sexo_Pet, Descricao_Pet, Idade_Pet, Foto_Pet, Porte_Pet, Status_Pet, Castrado, Nome_img, Cod_Usuario, Cod_Animal) values (@N_Pet, @Sexo_Pet, @Desc_Pet, @Idade_Pet, @Img_Pet, @Porte_Pet, @Stat_Pet, @castrado, @nome_foto, 1, last_insert_id());";
        ...
        #region Listar Pets
        public IEnumerable<PetsDTO> ListarPets(string porte, string sexo)
        {
            var conexao = ConnectionFactory.Build();
            conexao.Open();
